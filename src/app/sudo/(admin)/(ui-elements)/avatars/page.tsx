...
export const metadata: Metadata = {
  title: "Next.js Avatars | Apexcel Move - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Apexcel Move - Next.js Tailwind CSS Admin Dashboard Template",
};
