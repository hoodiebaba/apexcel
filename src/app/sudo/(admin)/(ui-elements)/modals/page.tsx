...
export const metadata: Metadata = {
  title: "Next.js Modals | Apexcel Move - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Apexcel Move - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
