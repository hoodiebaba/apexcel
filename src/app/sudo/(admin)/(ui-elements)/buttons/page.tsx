...
export const metadata: Metadata = {
  title: "Next.js Buttons | Apexcel Move - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Apexcel Move - Next.js Tailwind CSS Admin Dashboard Template",
};
