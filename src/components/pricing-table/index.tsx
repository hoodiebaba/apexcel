      ...
      <div className="overflow-hidden lg:max-w-none lg:flex">
        ...
        <div className="py-8 px-6 md:px-0 lg:flex-shrink-1">
          ...
          <p className="mt-6 text-base leading-6 text-gray-500">
            Lorem id ullamco pariatur eiusmod labore qui deserunt incididunt deserunt nostrud. 
            Tempor duis in adipisicing exercitation ipsum nostrud esse. 
            Reprehenderit cupidatat sint est deserunt id eiusmod amet aliqua officia.
          </p>
          ...
          <div className="mt-8">
            ...
            <ul className="mt-8 lg:grid lg:grid-cols-2 gap-y-4">
              {features.map((feature) => (
                <li className="flex items-center lg:col-span-1" key={feature}>
                  <div className="flex-shrink-0">
                    <Check className="h-8 w-8 mr-3 mb-1 text-indigo-500" />
                  </div>
