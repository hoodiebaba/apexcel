        ...
        <section>
          <figure>
            <div className="relative bg-white shadow rounded-lg">
              {/* Quote Icon */}
              <Quote className="w-16 md:w-12 absolute top-0 left-0 md:-left-2 pl-4 md:pl-0 text-gray-300" />
              ...
              <div className="pt-20 px-6 md:px-0">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/* Navigation arrows */}
                  <div className="cursor-pointer flex gap-2 pb-12">
                    <svg
                      ...
                      onClick={previous}
                      className="hover:stroke-gray-500 transition"
                    >
